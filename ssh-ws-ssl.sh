...
wget --no-check-certificate -q -O PDirect.js "https://raw.githubusercontent.com/MansurShop/AutoscriptV1/main/shop.js"
chmod +x PDirect.js
cd
...
cd /etc/william/
wget --no-check-certificate -q -O ODirect.py "https://raw.githubusercontent.com/MansurShop/AutoscriptV1/main/PDirectovpn.py"
